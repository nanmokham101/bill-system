create table bill (id bigint not null auto_increment, date_time varchar(255), description varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table roles (id integer not null auto_increment, name varchar(20), primary key (id)) engine=InnoDB;
create table transaction (transaction_id bigint not null auto_increment, amount integer, api_caller varchar(255), bill_id bigint, phone_number varchar(255), reference_no varchar(255), transaction_date varchar(255), primary key (transaction_id)) engine=InnoDB;
